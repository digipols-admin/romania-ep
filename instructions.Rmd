# Instructions on the Coding Method

### 1. The Aim of the Coding Exercise

The goal of the coding exercise is to estimate the positions of parties contesting the Romanian european election across a number of political issues (questions) in order to use them in the design of a Voting Advice Application (VAA). To do so, a coding method, best described as an "iterative expert survey", has been selected.
